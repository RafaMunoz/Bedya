...
<div id="wrapper">
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="servicios" class="active"><i class="fa fa-cogs fa-fw"></i> Servicios</a>
                    </li>
                    <li>
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"><i class="fa fa-cogs fa-fw"></i> Servicios</h1>
                </div>
            </div>
            
            
            <div class="well well-sm">
                <p>En este apartado vas a poder añadir los diferentes Servicios que posteriormente vas a administrar en tus equipos.<br>Nosotros te hemos añadido ya algunos, esperamos que te sean utiles y si no te gusta les puedes borrar sin ningun problema.</p>
                <p><i class="fa fa-gear fa-fw"></i> Nombre: Es el nombre que te aparecerá en el teclado personalizado de Telegram y te permitirá identificar el servicio.</p>
                <p><i class="fa fa-code fa-fw"></i> Servicio: Nombre que se utiliza para iniciar/detener el servicio.</p>
            </div>
                    
            <div class="row">
                <div class="col-lg-6" >
                    <div class="panel panel-green" >
                    <form action="nucleo/newservice" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6" >
                                    <div class="form-group input-group">
                                        ...
                                        <input class="form-control" placeholder="Servicio"  name="icomando" required>
                                    </div>    
                                </div>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <p>¿Seguro que quieres añadir un nuevo servicio?</p>
                                            </div>
                ...
                <div class="col-sm-6">
                    <div class="hero-widget well well-sm">
                        <span class="value"><i class="fa fa-gears fa-fw"></i> <?=$nservice?></span>
                    </div>
                    ...
                    if(isset($_GET['code'])){
                        if ($_GET['code']==1) {
                            ...
                            <div class="alert alert-danger alert-dismissable">
                                ...
                                Error al añadir nuevo servicio, es posible que ya exista.
                            </div>
                            <?php
                        }
                        if ($_GET['code']==2) {
                            ...
                            <div class="alert alert-success alert-dismissable">
                                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                                Nuevo servicio añadido correctamente.
                            </div>
                            <?php
                        }
                        if ($_GET['code']==3) {
           ...
           <div class="col-lg-4">
            <div class="well well-sm" style="word-wrap: break-word;">
                <p><i class="fa fa-gear fa-fw"></i> <?=$nb?></p>
                <p><i class="fa fa-code fa-fw"></i> <?=$name?></p>
