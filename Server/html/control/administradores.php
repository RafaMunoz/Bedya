<?php
    ...
    $options = ['projection' => ['_id'=>0,'admin'=>1]];
...
<div id="wrapper">
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="administradores" class="active"><i class="fa fa-users fa-fw"></i> Administradores</a>
                    </li>
                    <li>
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"><i class="fa fa-users fa-fw"></i> Administradores</h1>
                </div>
            </div>
            
            
            <div class="well well-sm">
                <p>En este apartado vas a poder añadir al sistema los Administradores que van a tener acceso a las notificaciones y control de los Bots que has dado anteriormente de alta.</p>
                <p>Para saber el id de cada administrador será necesario que vayan a <a href="https://telegram.me/bedya_bot" target="_blank">@Bedya_bot</a> y pulsen el botón <strong>ID Telegram</strong>.</p>
            </div>
                    
            <div class="row">
                <div class="col-lg-6" >
                    <div class="panel panel-green" >
                    <form action="nucleo/newadmin" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6" >
                                    <div class="form-group input-group">
                                        ...
                                        <input class="form-control" placeholder="ID Telegram" name="iid" required>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <p>¿Seguro que quieres añadir un nuevo administrador?</p>
                                            </div>
                ...
                <div class="col-sm-6">
                    <div class="hero-widget well well-sm">
                        <span class="value"><i class="fa fa-users fa-fw"></i> <?=$nadmin?></span>
                    </div>
                    ...
                    if(isset($_GET['code'])){
                        if ($_GET['code']==1) {
                            ...
                            <div class="alert alert-danger alert-dismissable">
                                ...
                                Error al añadir nuevo administrador, es posible que ya exista.
                            </div>
                            <?php
                        }
                        if ($_GET['code']==2) {
                            ...
                            <div class="alert alert-success alert-dismissable">
                                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                                Nuevo administrador añadido correctamente.
                            </div>
                            <?php
                        }
                        if ($_GET['code']==3) {
           ...
           <div class="col-lg-4">
            <div class="well well-sm" style="word-wrap: break-word;">
                <p><i class="fa fa-user fa-fw"></i> <?=$name?></p>
                <p><i class="fa fa-slack fa-fw"></i> <?=$id?></p>
                <form action="nucleo/codigo" method="POST">
                    <input type="hidden" name="codigo" value="1">
                    <input type="hidden" name="id" value="<?=$id?>">
                    <?php  
                        if ($id == $_SESSION["usuario"]) {
                            echo '<div style="text-align:right;"><button type="submit" class="btn btn-danger btn-circle disabled" ><i class="fa fa-times"></i></button></div>';
                        }
                        else{
                            echo '<div style="text-align:right;"><button type="submit" class="btn btn-danger btn-circle" ><i class="fa fa-times"></i></button></div>';
                        }
                    ?>
